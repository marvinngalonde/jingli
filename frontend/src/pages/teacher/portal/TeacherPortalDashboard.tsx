                ...
                <Grid align="center">
                    <Grid.Col span={{ base: 12, md: 8 }}>
                        <Group>
                            ...
                            <div>
                                <Text size="sm" fw={400} opacity={0.85}>{greeting}, Welcome to E-Learning portal</Text>
            ...
            <SimpleGrid cols={{ base: 2, md: 4 }} mb="lg">
                <Card shadow="sm" radius="md" p="md" withBorder>
                    <Group justify="space-between" mb="xs">
                        <Text size="sm" c="dimmed" fw={500}>My Classes</Text>
                ...
                <Card shadow="sm" radius="md" p="md" withBorder>
                    <Group justify="space-between" mb="xs">
                        <Text size="sm" c="dimmed" fw={500}>Syllabus Progress</Text>
                        <ThemeIcon variant="light" color="green" size="md"><IconCalendarEvent size={16} /></ThemeIcon>
                    </Group>
                    <Text fw={700} size="xl">{overallProgress}%</Text>
                </Card>
            </SimpleGrid>
