...
import { CreateTimetableEntryModal } from '../components/timetable/CreateTimetableEntryModal';
...
export default function Timetable() {
    ...
    // Be careful with API structure: level.sections might be undefined if not eager loaded, 
    // but classesApi.getAll() usually returns it.
