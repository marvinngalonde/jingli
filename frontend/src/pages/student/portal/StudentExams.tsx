...
import { Text, Badge, Group, Paper, Loader, Center, Card, ThemeIcon, SimpleGrid, Table, Stack, Tabs, Divider } from '@mantine/core';
import { IconCalendar, IconClock, IconBook } from '@tabler/icons-react';
...
export default function StudentExams() {
    ...
    return (
        <div>
            <PageHeader
                title="My Exams"
                subtitle="View your upcoming and past exams"
            />
